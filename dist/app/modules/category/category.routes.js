...
router.patch('/:id', (0, validateRequest_1.default)(category_validations_1.CategoryValidation.update), (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), category_controller_1.CategoryController.updateByIDFromDB);
