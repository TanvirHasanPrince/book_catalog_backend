...
router.patch('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), (0, validateRequest_1.default)(book_validations_1.BookValidation.update), book_controller_1.BookController.updateByIDFromDB);
router.get('/', book_controller_1.BookController.getAllFromDB);
router.get('/:id', book_controller_1.BookController.getByIdFromDB);
router.get('/:categoryId/category', book_controller_1.BookController.getBooksByCategoryIdFromDB);
